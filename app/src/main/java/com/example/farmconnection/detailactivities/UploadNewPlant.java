...
public class UploadNewPlant extends AppCompatActivity {

    private ImageView imageViewAddImage;
    private EditText editTextAddTitle,editTextAddDescription,editTextAddProvider,editTextAddPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextAddDescription = findViewById(R.id.editTextAddDecription);
        editTextAddProvider = findViewById(R.id.editTextAddProvider);
        ...
        imageViewAddImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(UploadNewPlant.this
                        , Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)
                {
                    ActivityCompat.requestPermissions(UploadNewPlant.this
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(UploadNewPlant.this, "Please select an image!", Toast.LENGTH_SHORT).show();
                }
                ...
                else
                {
                    ...
                    String provider = editTextAddProvider.getText().toString();
                    String price = editTextAddPrice.getText().toString();
                    ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
                    scaledImage = makeSmall(selectedImage,250);
